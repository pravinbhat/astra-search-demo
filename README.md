...
- `$hybrid` is automatically populated with book title, author, summary, genre and ISBN information
...
- 📝 **Lexical Search** - Keyword-based search using AstraDB's `$lexical` operator for indexed terms that benefit from keyword matching
